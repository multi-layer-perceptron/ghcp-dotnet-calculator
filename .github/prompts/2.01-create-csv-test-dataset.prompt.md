...
Create a new folder named `TestData` inside the test project directory at `$(git rev-parse --show-toplevel)\src\workspace\calculator-xunit-testing\calculator.tests`. Place the CSV file named `CalculatorTestData.csv` inside this folder.
